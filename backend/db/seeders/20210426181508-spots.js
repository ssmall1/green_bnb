  ...
  up: (queryInterface, Sequelize) => {
      return queryInterface.bulkInsert('Spots', [
        ...
        },
        {
          ...
          description: "Located near Asheville, North Carolina, this tree house-style elevated cabin is 600 square feet in size and is situated at an elevation of 2,100 feet, accommodating six guests. The house includes a number of different practices and processes, such as denim insulation in the walls, an advanced greywater treatment system, wood milled from the property that is untreated and chemical free, a waterless toilet (doesn't waste water and creates high-quality fertilizer), recycling and composting, and more.",
